...
public class OK_Gocardless2 {
    ...
    public void gocardless() throws InterruptedException {
        ...
        //mail adresi gir
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys(Objects2.eMail);
        ...
        //şifre gir
        driver.findElement(By.xpath("//input[@id='password']")).sendKeys("Besiktas01!Besitas01!");
