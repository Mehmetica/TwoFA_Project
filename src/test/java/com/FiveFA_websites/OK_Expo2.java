...
public class OK_Expo2 {
    ...
    public void expo() throws InterruptedException {
        ...
        //mail adresi gir
        driver.findElement(By.xpath("//input[@id='usernameOrEmail']")).sendKeys(Objects2.eMail);
        ...
        //şifre gir
        driver.findElement(By.xpath("//input[@id='password']")).sendKeys(Objects2.password);
